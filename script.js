...
function generarRespuestaBot(mensaje) {
  ...
  if (texto.includes('hola') || texto.includes('buenas')) {
    return "¡Hola! Gusto en conocerte ¿En qué puedo ayudarte hoy?";
  } 
  else if (texto.includes('precio') || texto.includes('costo') || texto.includes('cuanto cuesta')) {
    return "Nuestros servicios tienen precios variados. Puedes consultar el área de Producto o Metodo De Pago para más detalles.";
  } 
  else if (texto.includes('horario') || texto.includes('abierto')) {
    return "Atendemos de Lunes a Viernes de 9:00 am a 8:00 pm y los dias Sabados de 10:00 am a 4:00 pm.";
  } 
    ...
    return "¡De nada! Estoy para servirte y responder cualquier duda.";
  } 
  else {
